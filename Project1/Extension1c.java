...
public class Extension1c{
	...
	public static void main( String[] args ){
		...
		System.out.println("Average # of Pushes =" + " " + (totalPushes/1000.0));
		System.out.println("Average # of Player Wins =" + " " + (totalPlayer/1000.0));
		System.out.println("Average # of Dealer Wins =" + " " + (totalDealer/1000.0));	
